...
class StandAloneBillingSystemPlugin implements IBillingSystemPlugin {
   ...
   * a LEAD_TIME in PC2BC50PaymentSmokeTest but that's to match BC.  Here is the LEAD_TIME we use in the standalone
  ...
  override function syncPolicyLevelCommissionRatesForPolicyTransaction(policyPeriod: PolicyPeriod) {
    policyPeriod.DefaultPriCmsnRate = 10.00bd
  }
